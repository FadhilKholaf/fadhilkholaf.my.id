...
export default function LeftSidebar() {
  ...
  return (
    <aside className="fixed z-50 flex h-screen w-8 flex-col items-center justify-center gap-16 overflow-hidden bg-secondary text-primary lg:w-12">
      <p className="absolute top-0 mt-8 -rotate-90 text-nowrap font-semibold text-accent">
      ...
      <p className="absolute bottom-0 mb-8 -rotate-90 text-nowrap font-semibold text-accent">
